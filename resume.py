...
myresume=resume()
myresume.add_name('Cat_prog','Solution developer, technical artist')
myresume.add_contact('email','arcs3567@gmail.com')
myresume.add_contact('github','https://github.com/techeditorsrc/Python')
myresume.add_paragraph('Skills','Python','I have a basics experience with Python programming. I developing solutions for Python projects, console applications, gui applications using pygame.')
myresume.add_paragraph('Skills','Visual Basic for Applications','I have experience with Visual Basic for Applications for LibreOffice. I developing solutions to add custom functions and user forms.')
myresume.add_paragraph('Summary','Summary information','I\'m hardworking, responsible. I developing solutions. In my work I orient on a client success.')
myresume.render()
